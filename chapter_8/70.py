...
def load_word_embeddings(
        model_path: str = "GoogleNews-vectors-negative300.bin",
    ...
    """
    model
    ├── key_to_index: {'apple': 0, 'banana': 1, 'orange': 2, ...}
    ├── index_to_key: ['apple', 'banana', 'orange', ...]
    ├── vectors: numpy.ndarray([[0.12, 0.45, ...], [0.23, 0.67, ...], ...])
    └── vector_size: 300
    """
    ...
    #単語埋め込み行列の２行目以降に事前学習済み単語ベクトルを格納
